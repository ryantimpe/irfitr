...
#' @param minimum_distribution Optional value of the minimum percent share of any new band element. (e.g. 0.01 means no bands can contain less than 1 percent of group total.)
